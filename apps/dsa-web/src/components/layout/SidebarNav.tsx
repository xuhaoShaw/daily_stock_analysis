...
import { BarChart3, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Radar, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'recommendations', label: '推荐', to: '/recommendations', icon: Radar },
